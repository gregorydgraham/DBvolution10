...
/**
 * Provides a portable representation of a column of Polygon3D values.
 *
 * @author Gregory Graham
 */
public class Polygon3DColumn extends Polygon3DExpression implements ColumnProvider {
	 ...
	 */
	public Polygon3DColumn(RowDefinition row, DBPolygon3D field) {
