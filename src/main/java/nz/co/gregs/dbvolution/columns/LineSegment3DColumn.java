...
/**
 * Provides a portable representation of a column of Line3D values.
 *
 * @author Gregory Graham
 */
public class LineSegment3DColumn extends LineSegment3DExpression implements ColumnProvider {
	 ...
	 */
	public LineSegment3DColumn(RowDefinition row, DBLineSegment3D field) {
