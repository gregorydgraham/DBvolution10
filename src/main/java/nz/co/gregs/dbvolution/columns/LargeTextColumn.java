...
import nz.co.gregs.dbvolution.expressions.LargeTextExpression;
import nz.co.gregs.dbvolution.expressions.SortProvider;
import nz.co.gregs.dbvolution.query.RowDefinition;

public class LargeTextColumn extends LargeTextExpression implements ColumnProvider {

	private static final long serialVersionUID = 1L;

	private AbstractColumn column;

	protected LargeTextColumn() {
		super();
	}

	public LargeTextColumn(RowDefinition row, DBLargeText field) {
