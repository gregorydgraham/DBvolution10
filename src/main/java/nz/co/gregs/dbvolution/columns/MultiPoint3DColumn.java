 ...
 */
public class MultiPoint3DColumn extends MultiPoint3DExpression implements ColumnProvider {
	 ...
	 */
	public MultiPoint3DColumn(RowDefinition row, DBMultiPoint3D field) {
