...
import nz.co.gregs.dbvolution.expressions.LargeBinaryExpression;
import nz.co.gregs.dbvolution.expressions.SortProvider;
import nz.co.gregs.dbvolution.query.RowDefinition;

public class LargeBinaryColumn extends LargeBinaryExpression implements ColumnProvider {

	private static final long serialVersionUID = 1L;

	private AbstractColumn column;

	protected LargeBinaryColumn() {
		super();
	}

	public LargeBinaryColumn(RowDefinition row, DBLargeBinary field) {
