...
/**
 * Provides a portable representation of a column of Point3D values.
 *
 * @author Gregory Graham
 */
public class Point3DColumn extends Point3DExpression implements ColumnProvider {
	 ...
	 */
	public Point3DColumn(RowDefinition row, DBPoint3D field) {
