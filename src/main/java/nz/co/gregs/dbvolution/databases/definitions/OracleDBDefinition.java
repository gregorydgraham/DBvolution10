...
public class OracleDBDefinition extends DBDefinition {
	...
	private final String oracleDateFormatStr = "YYYY-MM-DD HH24:MI:SS.FF3 TZHTZM";
	private final SimpleDateFormat javaToStringFormatter = new SimpleDateFormat(dateFormatStr);
