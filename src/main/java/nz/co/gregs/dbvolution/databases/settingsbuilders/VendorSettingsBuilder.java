 ...
 */
public interface VendorSettingsBuilder<SELF extends VendorSettingsBuilder<SELF, DATABASE>, DATABASE extends DBDatabase> extends SettingsBuilder<SELF, DATABASE> {
