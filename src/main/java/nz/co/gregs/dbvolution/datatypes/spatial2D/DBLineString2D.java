...
public class DBLineString2D extends QueryableDatatype {

	private static final long serialVersionUID = 1L;

	public DBLineString2D() {
	}

	public DBLineString2D(Object obj) {
		super(obj);
	}

	public DBLineString2D(DBExpression columnExpression) {
