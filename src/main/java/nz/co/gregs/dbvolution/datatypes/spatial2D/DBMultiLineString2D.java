...
public class DBMultiLineString2D extends QueryableDatatype {

	private static final long serialVersionUID = 1L;

	public DBMultiLineString2D() {
	}

	public DBMultiLineString2D(Object obj) {
		super(obj);
	}

	public DBMultiLineString2D(DBExpression columnExpression) {
