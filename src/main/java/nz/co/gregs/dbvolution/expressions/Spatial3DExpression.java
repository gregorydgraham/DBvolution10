...
/**
 * Designates the expression as a Spatial3D expression.
 *
 * @author gregorygraham
 */
public interface Spatial3DExpression extends Spatial3DResult {
	...
	/**
	 * Return a expression that provides the largest Z value within the spatial
	 * value.
	 *
	 * @return a NumberExpression
	 */
	...
	/**
	 * Return a expression that provides the smallest Z value within the spatial
	 * value.
	 *
	 * @return a NumberExpression
	 */
