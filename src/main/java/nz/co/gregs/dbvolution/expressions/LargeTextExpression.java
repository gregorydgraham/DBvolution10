...
public class LargeTextExpression extends LargeObjectExpression<byte[], LargeTextResult, DBLargeText> implements LargeTextResult, ExpressionColumn<DBLargeText>{
	...
	public LargeTextExpression(LargeTextResult originalBlob) {
		super(originalBlob);
	}

	@Override
	public LargeTextResult expression(byte[] value) {
		return new LargeTextExpression(new DBLargeText(value));
	}

	@Override
	public LargeTextResult expression(LargeTextResult value) {
		return new LargeTextExpression(value);
	}

	@Override
	public LargeTextResult expression(DBLargeText value) {
		return new LargeTextExpression(value);
	}
