 ...
 */
public enum Line3DFunctions implements DBVFeature {
	 ...
	 *
	 */
	EQUALS("DBV_LINE3D_EQUALS", "Boolean", "String firstLine, String secondLine", "\n"
	 ...
	 *
	 */
	MAXX("DBV_LINE3D_MAXX", "Double", "String firstLine", "\n"
			+ "			if (firstLine == null) {\n"
			+ "				return null;\n"
			+ "			} else {\n"
			+ "				Double maxX = null;\n"
	 ...
	 *
	 */
	MAXY("DBV_LINE3D_MAXY", "Double", "String firstLine", "\n"
			+ "			if (firstLine == null) {\n"
			+ "				return null;\n"
			+ "			} else {\n"
			+ "				Double maxY = null;\n"
	 ...
	 *
	 */
	MAXZ("DBV_LINE3D_MAXZ", "Double", "String firstLine", "\n"
			+ "			if (firstLine == null) {\n"
			+ "				return null;\n"
			+ "			} else {\n"
			+ "				Double maxZ = null;\n"
	 ...
	 *
	 */
	MINX("DBV_LINE3D_MINX", "Double", "String firstLine", "\n"
			+ "			if (firstLine == null) {\n"
			+ "				return null;\n"
			+ "			} else {\n"
			+ "				Double maxX = null;\n"
	 ...
	 *
	 */
	MINY("DBV_LINE3D_MINY", "Double", "String firstLine", "\n"
			+ "			if (firstLine == null) {\n"
			+ "				return null;\n"
			+ "			} else {\n"
			+ "				Double maxY = null;\n"
	 ...
	 *
	 */
	MINZ("DBV_LINE3D_MINZ", "Double", "String firstLine", "\n"
			+ "			if (firstLine == null) {\n"
			+ "				return null;\n"
			+ "			} else {\n"
			+ "				Double maxZ = null;\n"
	 ...
	 *
	 */
	BOUNDINGBOX("DBV_LINE3D_BOUNDINGBOX", "String", "String firstLine", "\n"
			+ "			if (firstLine == null) {\n"
			+ "				return null;\n"
			+ "			} else {\n"
			+ "				Double maxX = null;\n"
	 ...
	 *
	 */
	DIMENSION("DBV_LINE3D_DIMENSION", "Integer", "String firstLine", "return 1;"),

	/**
	 *
	 */
	ASTEXT("DBV_LINE3D_ASTEXT", "String", "String firstLine", "return firstLine;"),

	/**
	 *
	 */
	INTERSECTS_LINE3D("DBV_LINE3D_INTERSECTS_LINE3D", "Boolean", "String firstLine, String secondLine", "\n"
			+ "		if (firstLine == null || secondLine == null) {\n"
			+ "			return null;\n"
			+ "		}\n"
			...
			+ "\n"
			+ "				if (s >= 0 && s <= 1 && t >= 0 && t <= 1) {\n"
			+ "					// Collision detected ignoring Z, now to check z values\n"
	 ...
	 *
	 */
	INTERSECTIONWITH_LINE3D("DBV_LINE3D_INTERSECTIONWITH_LINE3D", "String", "String firstLine, String secondLine", "\n"
			+ "		if (firstLine == null || secondLine == null) {\n"
			+ "			return null;\n"
			+ "		}\n"
			+ "		String[] split1 = firstLine.split(\"[ (),]+\");\n"
	 ...
	 *
	 */
	ALLINTERSECTIONSWITH_LINE3D("DBV_LINE3D_ALLINTERSECTIONSWITH_LINE3D", "String", "String firstLine, String secondLine", "\n"
			+ "		if (firstLine == null || secondLine == null) {\n"
			+ "			return null;\n"
			+ "		}\n"
			+ "		String result = \"\";\n"
			...
			+ "					     i_x = p0x + (t * s1_x);\n"
			+ "				     	i_y = p0y + (t * s1_y);\n"
			+ "				     	result += pointSeparator + i_x + \" \" + i_y + \" \" + t_z;\n"
			+ "				     	pointSeparator = \", \";\n"
			+ "				     }\n"
			+ "				}\n"
			+ "			}\n"
	...
	Line3DFunctions(String functionName, String returnType, String parameters, String code) {
