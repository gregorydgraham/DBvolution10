 ...
 */
public class BlockingDBAction extends DBAction {

	private static int counter = 0;
	private static final long serialVersionUID = 1L;
	private final Brake brake = Brake.defaultSettings();

	public BlockingDBAction() {
		super(null, QueryIntention.NO_OP);
	}
	
	public BlockingDBAction(long milliseconds) {
		this();
		brake.setTimeout(milliseconds);
	}
