...
public class OutputFormatTest extends AbstractTest {
	...
	public void testFormatAllTableTSV() throws SQLException {
		...
		assertThat(formatDBRows, is("name	uidCarCompany" + newline + "TOYOTA	1" + newline));
	...
	public void testFormatAllTableHTML() throws SQLException {
		...
		assertThat(formatDBRows.replaceAll(".00000", ""), is("<tr class=\"headerrow\"><th class=\"headercell\">name</th><th class=\"headercell\">uidCarCompany</th></tr>" + newline
		...
		assertThat(formatDBRows.replaceAll(".00000", ""), is("<tr class=\"\"><th class=\"\">name</th><th class=\"\">uidCarCompany</th></tr>" + newline
