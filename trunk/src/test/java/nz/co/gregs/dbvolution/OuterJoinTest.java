	...
	public void testANSIInnerJoinQueryCreation() throws Exception {
		...
		Assert.assertThat(
				...
				anyOf(
						...
						is(testableSQL("car_company as __78874071 inner join marque as __1997432637 on( __1997432637.fk_carcompany = __78874071.uid_carcompany )"))
				));
