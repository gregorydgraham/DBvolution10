...
public class DBMultiLineString extends QueryableDatatype {

	public DBMultiLineString() {
	}

	public DBMultiLineString(Object obj) {
		super(obj);
	}

	public DBMultiLineString(DBExpression columnExpression) {
