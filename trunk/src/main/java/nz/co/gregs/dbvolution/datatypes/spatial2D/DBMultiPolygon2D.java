...
public class DBMultiPolygon2D extends QueryableDatatype {

	private static final long serialVersionUID = 1L;

	public DBMultiPolygon2D() {
	}

	public DBMultiPolygon2D(Object obj) {
		super(obj);
	}

	public DBMultiPolygon2D(DBExpression columnExpression) {
