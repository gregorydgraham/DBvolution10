 ...
 *
 * <p>
 * DBTableOLD is a quick and easy API for targeted data retrieval, for more
 * complex needs use {@link DBQuery}.
 *
 *
...
//        }
	 ...
	 * @return a DBTableOLD instance containing the row(s) for the primary key 1
	 ...
	 *
	 * <p>
	 * The following will the only record from the table where the Language column
	 * contains JAVA:<br> {@code MyTableRow myExample = new MyTableRow();}<br>
     * {@code myExample.getLanguage.useLikeComparison("%JAVA%"); }<br>
	...
	/**
	 * For the particularly hard queries, just provide the actual WHERE clause you
	 * want to use.
	 *
	 * <p>
	 ...
	 * @return a DBActionList of all the changes required. 1 Database exceptions
	 * may be thrown
	 * @throws java.sql.SQLException java.sql.SQLException
	 */
	...
	/**
	 *
	 * @return a list of all the primary keys. 1 Database exceptions may be thrown
	 * @throws java.sql.SQLException java.sql.SQLException
	 */
