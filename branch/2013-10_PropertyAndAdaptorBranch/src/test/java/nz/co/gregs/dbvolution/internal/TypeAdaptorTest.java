...
/**
 * Focuses on end-to-end functionality with regards to type adaptors
 * against an actual database.
 * More detailed low-level unit testing of Type Adaptor functionality
 * is in {@link PropertyTypeHandlerTest}.
 */
